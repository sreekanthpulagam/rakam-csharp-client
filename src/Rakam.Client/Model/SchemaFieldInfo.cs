...
namespace Rakam.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SchemaFieldInfo :  IEquatable<SchemaFieldInfo>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemaFieldInfo" /> class.
        /// </summary>
        /// <param name="Category">Category.</param>
        /// <param name="Type">Type.</param>
        public SchemaFieldInfo(string Category = null, TypeEnum? Type = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SchemaFieldInfo);
        }

        /// <summary>
        /// Returns true if SchemaFieldInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of SchemaFieldInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchemaFieldInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
