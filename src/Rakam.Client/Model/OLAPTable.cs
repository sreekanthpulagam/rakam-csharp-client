...
namespace Rakam.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OLAPTable :  IEquatable<OLAPTable>
    {
        ...
        /// <param name="Aggregations">Aggregations (required).</param>
        /// <param name="Measures">Measures (required).</param>
        /// <param name="TableName">TableName (required).</param>
        public OLAPTable(List<string> Collections = null, List<string> Dimensions = null, List<AggregationsEnum> Aggregations = null, List<string> Measures = null, string TableName = null)
        {
            // to ensure "Collections" is required (not null)
            if (Collections == null)
            {
                throw new InvalidDataException("Collections is a required property for OLAPTable and cannot be null");
            }
            else
            {
            ...
            if (Dimensions == null)
            {
                throw new InvalidDataException("Dimensions is a required property for OLAPTable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("Aggregations is a required property for OLAPTable and cannot be null");
            }
            else
            {
            ...
            if (Measures == null)
            {
                throw new InvalidDataException("Measures is a required property for OLAPTable and cannot be null");
            }
            else
            {
            ...
            if (TableName == null)
            {
                throw new InvalidDataException("TableName is a required property for OLAPTable and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <param name="other">Instance of OLAPTable to be compared</param>
        /// <returns>Boolean</returns>
